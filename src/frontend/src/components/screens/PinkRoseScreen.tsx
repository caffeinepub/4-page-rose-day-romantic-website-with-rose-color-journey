...
export default function PinkRoseScreen() {
  return (
        ...
        <Card className="max-w-4xl w-full bg-white/80 backdrop-blur-md border-0 shadow-2xl rounded-3xl overflow-hidden">
          <div className="p-8 md:p-12">
            ...
            <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-xl mb-8">
              <img
                src="/assets/generated/pink-rose-hero.dim_1600x900.png"
                alt="Pink Rose"
            ...
            <div className="text-center space-y-4">
              <h2 className="text-4xl md:text-5xl font-serif text-pink-700 font-bold">
                Your Favorite
              </h2>
              <p className="text-lg md:text-xl text-pink-600/80 font-light italic">
                Pink roses for the sweetest soul I know...
              </p>
            </div>
          </div>
        </Card>
